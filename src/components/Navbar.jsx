...
import TowTruckLogo from './TowTruckLogo';
    ...
    <>
      ...
      <div className="hidden lg:flex bg-primary/90 text-white text-xs font-medium items-center justify-between px-8 py-1.5 font-poppins tracking-wide">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="tel:+919880166968" className="flex items-center gap-2 font-bold hover:text-accent transition-colors">
            <Phone className="h-3 w-3" />
            <span>+91 98801 66968</span>
          </a>
        </div>
      </div>
